...
// === Ограничение длительности речи ===
// Одна передача занимает канал целиком, поэтому речь ограничена по времени —
// и в потоковом режиме, и при записи голосового сообщения. Десять секунд
// хватает на осмысленную фразу и не превращают канал в чью-то собственность.
#define PTT_MAX_SECONDS 10
