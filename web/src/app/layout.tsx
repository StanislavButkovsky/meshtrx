...
export const metadata: Metadata = {
  ...
  // Файл favicon.ico в public/ лежал с самого начала, но был пустой — 0 байт.
  // Сервер отдавал его с кодом 200, браузеру доставалась пустота, и вкладка
  // оставалась без значка. Пустой файл тем и коварен, что выглядит как
  // настроенный: и файл на месте, и запрос успешен.
  icons: {
    icon: [
